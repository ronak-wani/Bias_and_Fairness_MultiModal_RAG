...
if __name__ == "__main__":
    ...
    MiniCPM_V_Text_To_Text_Retrieval = MultiModalRAG("minicpm-v:latest", "text_to_text", benchmark, 250)
    MiniCPM_V_Image_To_Image_Retrieval = MultiModalRAG("minicpm-v:latest", "image_to_image", benchmark, 250)
    MiniCPM_V_Both_To_Both_Retrieval = MultiModalRAG("minicpm-v:latest", "both_to_both", benchmark, 250)

    Qwen3_VL_Text_To_Text_Retrieval = MultiModalRAG("qwen3-vl:2b", "text_to_text", benchmark, 250)
    Qwen3_VL_Image_To_Image_Retrieval = MultiModalRAG("qwen3-vl:2b", "image_to_image", benchmark, 250)
    Qwen3_VL_Both_To_Both_Retrieval = MultiModalRAG("qwen3-vl:2b", "both_to_both", benchmark, 250)
